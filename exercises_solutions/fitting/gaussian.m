function gamma=gaussian(h, r, C0, b)
  % gaussian - calculate the spherical variogram model
  %
  % Calculates the semi-variance value for a given lag h using the Gaussian 
